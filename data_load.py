...
# -----------------------
# Insert Appliances (Option 3: ON CONFLICT)
# -----------------------
with engine.connect() as conn:
    ...
    conn.commit()
print("✅ Appliances inserted without duplicates!")

# -----------------------
# Insert Usage Logs (Sample)
# -----------------------
...
# -----------------------
# Forecast Appliance Usage with Prophet
# -----------------------
